...
//                            
//                            let normal0 = gameModel.getNormal(fromMap: fireResult.top, longitude: Int(xArr[k]), latitude: Int(yArr[k]))
//                            let normal1 = gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[k]), latitude: Int(yArr[k]))
//                            dropNormals0.append(fromModelScale(normal0))
//                            dropNormals1.append(fromModelScale(normal1))
//
...
//                            
//                            let normal0 = gameModel.getNormal(fromMap: fireResult.middle, longitude: Int(xArr[k]), latitude: Int(yArr[k]))
//                            let normal1 = gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[k]), latitude: Int(yArr[k]))
//                            dropNormals0.append(fromModelScale(vectorScale(normal0, by: -1)))
//                            dropNormals1.append(fromModelScale(vectorScale(normal1, by: -1)))
//
//                            dropTexCoords.append(toMapSpace(x: xArr[k], y: yArr[k]))
//                            dropIndices.append(CInt(dropVertices0.count-1))
//                        }
...
//                                                                               bottomArr[k] + (topArr[k]-middleArr[k]))))
//                                
//                                dropNormals0.append(fromModelScale(gameModel.getNormal(fromMap: fireResult.top, longitude: Int(xArr[k]), latitude: Int(yArr[k]))))
//                                dropNormals1.append(fromModelScale(gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[k]), latitude: Int(yArr[k]))))
//                                
//                                dropTexCoords.append(toMapSpace(x: xArr[k], y: yArr[k]))
//                            }
...
//                                                                           currentArr[noDrop])))
//
//                            var normal0 = gameModel.getNormal(fromMap: fireResult.top, longitude: Int(xArr[noDrop]), latitude: Int(yArr[noDrop]))
//                            var normal1 = gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[noDrop]), latitude: Int(yArr[noDrop]))
//                            dropNormals0.append(fromModelScale(normal0))
//                            dropNormals1.append(fromModelScale(normal1))
//                            
...
//                                                                           currentArr[noDrop])))
//
//                            normal0 = gameModel.getNormal(fromMap: fireResult.middle, longitude: Int(xArr[noDrop]), latitude: Int(yArr[noDrop]))
//                            normal1 = gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[noDrop]), latitude: Int(yArr[noDrop]))
//                            dropNormals0.append(fromModelScale(vectorScale(normal0, by: -1)))
//                            dropNormals1.append(fromModelScale(vectorScale(normal1, by: -1)))
//                            
//                            dropTexCoords.append(toMapSpace(x: xArr[noDrop], y: yArr[noDrop]))
...
//                        
//                            let p1 = Vector3(xArr[idx1], yArr[idx1], topArr[idx1])
//                            let p2 = Vector3(xArr[idx2], yArr[idx2], topArr[idx2])
//                            let p3 = Vector3(xArr[idx1], yArr[idx1], middleArr[idx1])
//                            let vect1 = vectorDiff(p1, p2)
//                            let vect2 = vectorDiff(p3, p2)
//                            let normal = vectorCross(vect1, vect2)
//
//                            let viewNormal = fromModelScale(normal)
//                            dropNormals0.append(viewNormal)
//                            dropNormals0.append(viewNormal)
//                            dropNormals0.append(viewNormal)
//                            dropNormals0.append(viewNormal)
//                            dropNormals1.append(viewNormal)
//                            dropNormals1.append(viewNormal)
//                            dropNormals1.append(viewNormal)
//                            dropNormals1.append(viewNormal)
//
...
//                            
//                            dropNormals0.append(fromModelScale(gameModel.getNormal(fromMap: fireResult.top, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1]))))
//                            dropNormals0.append(fromModelScale(gameModel.getNormal(fromMap: fireResult.top, longitude: Int(xArr[idx2]), latitude: Int(yArr[idx2]))))
//                            dropNormals0.append(fromModelScale(gameModel.getNormal(fromMap: fireResult.top, longitude: Int(xArr[idx3]), latitude: Int(yArr[idx3]))))
//                            
//                            dropNormals1.append(fromModelScale(gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1]))))
//                            dropNormals1.append(fromModelScale(gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[idx2]), latitude: Int(yArr[idx2]))))
//                            dropNormals1.append(fromModelScale(gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[idx3]), latitude: Int(yArr[idx3]))))
//                            
//                            dropTexCoords.append(toMapSpace(x: xArr[idx1], y: yArr[idx1]))
//                            dropTexCoords.append(toMapSpace(x: xArr[idx2], y: yArr[idx2]))
...
//                            
//                            dropNormals0.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.middle, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1])), by: -1)))
//                            dropNormals0.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.middle, longitude: Int(xArr[idx2]), latitude: Int(yArr[idx2])), by: -1)))
//                            dropNormals0.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.middle, longitude: Int(xArr[idx3]), latitude: Int(yArr[idx3])), by: -1)))
//                            
//                            dropNormals1.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1])), by: -1)))
//                            dropNormals1.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[idx2]), latitude: Int(yArr[idx2])), by: -1)))
//                            dropNormals1.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[idx3]), latitude: Int(yArr[idx3])), by: -1)))
//                            
//                            dropTexCoords.append(toMapSpace(x: xArr[idx1], y: yArr[idx1]))
//                            dropTexCoords.append(toMapSpace(x: xArr[idx2], y: yArr[idx2]))
//                            dropTexCoords.append(toMapSpace(x: xArr[idx3], y: yArr[idx3]))
...
//                                                                       bottomArr[idx3] + (topArr[idx3]-middleArr[idx3]))))
//                        
//                        dropNormals0.append(fromModelScale(gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1]))))
//                        dropNormals0.append(fromModelScale(gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[idx2]), latitude: Int(yArr[idx2]))))
//                        dropNormals0.append(fromModelScale(gameModel.getNormal(fromMap: fireResult.top, longitude: Int(xArr[idx3]), latitude: Int(yArr[idx3]))))
//                        
//                        dropNormals1.append(fromModelScale(gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1]))))
//                        dropNormals1.append(fromModelScale(gameModel.getNormal(fromMap: gameModel.board.surface, longitude: Int(xArr[idx2]), latitude: Int(yArr[idx2]))))
...
//                        dropVertices1.append(fromModelSpace(Vector3(xArr[idx3], yArr[idx3], bottomArr[idx3])))
//                        
//                        dropNormals0.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1])), by: -1)))
//                        dropNormals0.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.middle, longitude: Int(xArr[idx2]), latitude: Int(yArr[idx2])), by: -1)))
//                        dropNormals0.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.middle, longitude: Int(xArr[idx3]), latitude: Int(yArr[idx3])), by: -1)))
//                        
//                        dropNormals1.append(fromModelScale(vectorScale(gameModel.getNormal(fromMap: fireResult.bottom, longitude: Int(xArr[idx1]), latitude: Int(yArr[idx1])), by: -1)))
...
//            let dropNormSrc0 = SCNGeometrySource(normals: dropNormals0)
//            let dropNormSrc1 = SCNGeometrySource(normals: dropNormals1)
...
//            let dropGeometry0 = SCNGeometry(sources: [dropSource0, dropTexSource, dropNormSrc0], elements: [elements])
//            let dropGeometry1 = SCNGeometry(sources: [dropSource1, dropTexSource, dropNormSrc1], elements: [elements])
